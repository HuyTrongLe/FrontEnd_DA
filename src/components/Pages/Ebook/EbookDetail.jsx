        ...
        try {
          ...
          await Swal.fire({
            ...
            socket.emit("sendNotification", {
              ...
              content: `${accountOnline} đã mua sách điện tử ${ebook.ebookName} của bạn`,
            });
            const addNotification = () => {
              const newNotificationData = {
                accountId: ebook.createById,
                content: `${accountOnline} đã mua công thức ${ebook.ebookName} của bạn`,
            ...
            <div className="flex gap-4">
              {!isPurchased ? (
                <button
                  ...
                  className={`w-full py-3 ${isProcessing ? 'bg-gray-400' : 'bg-green-600 hover:bg-green-700'
